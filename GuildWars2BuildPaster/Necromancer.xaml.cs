...
{
    /// <summary>
    /// Interaction logic for Necromancer.xaml
    /// </summary>
    public partial class Necromancer : Page
    {
        ...
        private void ReadDatabase()
        {
            using (SQLite.SQLiteConnection conn = new SQLite.SQLiteConnection(DatabasePath.databasePath))
            {
                ...
                builds = (conn.Table<Build>().ToList()).Where(v => v.Profession.Equals("Necromancer")).ToList();
            }
