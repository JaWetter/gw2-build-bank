...
{
    /// <summary>
    /// Interaction logic for Elementalist.xaml
    /// </summary>
    public partial class Elementalist : Page
    {
        ...
        private void ReadDatabase()
        {
            using (SQLite.SQLiteConnection conn = new SQLite.SQLiteConnection(DatabasePath.databasePath))
            {
                ...
                builds = (conn.Table<Build>().ToList()).Where(v => v.Profession.Equals("Elementalist")).ToList();
            }
